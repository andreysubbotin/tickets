...
import { Route, useLocation, useMatch, useNavigate, useParams } from "react-router-dom";
...
export const PaletteTree = () => (
  <Palette>
    ...
    <Category name="React Router">
      <Component name="Route" docURL="https://reactrouter.com/en/main/route/route">
        <Variant>
          <Route path="path" element={null} />
        </Variant>
        <Variant name="errorElement">
          <Route
            path="path"
            element={null}
            errorElement={<span style={{ color: "red" }}>Error</span>}
          />
        </Variant>
      </Component>
      <Component name="useLocation" docURL="https://reactrouter.com/en/main/hooks/use-location">
        <Variant proto={UseLocationProto} />
      </Component>
      <Component name="useMatch" docURL="https://reactrouter.com/en/main/hooks/use-match">
        <Variant proto={UseMatchProto} />
      </Component>
      <Component name="useNavigate" docURL="https://reactrouter.com/en/main/hooks/use-navigate">
        <Variant proto={UseNavigateProto} />
      </Component>
      <Component name="useParams" docURL="https://reactrouter.com/en/main/hooks/use-params">
        <Variant proto={UseParamsProto} />
      </Component>
    </Category>
      ...
      >
        <Variant name="create file">
          <FileInput
            ...
            uploadUrlQuery={gql(``)} // TODO place your file upload url gql query here
          />
        </Variant>
        <Variant name="edit file">
          <FileInput
            fileIdSource="fileIdSourceName"
            uploadUrlQuery={gql(``)} // TODO place your file upload url gql query here
            downloadUrlQuery={gql(``)} // TODO place your file download url gql query here
          />
        </Variant>
...
const UseLocationProto = () => {
  const location = useLocation();
};

const UseNavigateProto = () => {
  const navigate = useNavigate();
};

const UseParamsProto = () => {
  const {paramName} = useParams();
};

const UseMatchProto = () => {
  const matchResult = useMatch('path');
};
